"""
PyTorch port of deep_q_network_breakout.py from keras-io
(@see: https://github.com/keras-team/keras-io/blob/master/examples/rl/deep_q_network_breakout.py)
...
References:
- [Atari Breakout(BreakoutNoFrameskip-v4)](https://gymnasium.farama.org/environments/wrapper/atari_preprocessing/)
...
# improves training time. ClipNorm before optimizer.step()
    ...
    for timestep in range(1, max_steps_per_episode):
        ...
        if frame_count % update_after_actions == 0 and len(done_history) > batch_size:
            ...
            with torch.enable_grad():
                ...
                torch.nn.utils.clip_grad_norm_(model.parameters(), max_norm=1.0) # Clip norm as per orig impl
                optimizer.step()
